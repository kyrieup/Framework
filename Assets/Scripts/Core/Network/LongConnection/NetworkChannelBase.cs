...
public abstract class NetworkChannelBase : INetworkChannel, IDisposable
{
    ...
    protected readonly Queue<Packet> m_ReceivePacketPool;
    protected readonly INetworkChannelHelper m_NetworkChannelHelper;
    protected EAddressFamily m_AddressFamily;
    ...
    public NetworkChannelBase(string name, INetworkChannelHelper networkChannelHelper)
    {
        ...
        m_ReceivePacketPool = new List<Packet>();
        m_NetworkChannelHelper = networkChannelHelper;
        m_AddressFamily = EAddressFamily.Unknown;
    ...
    /// 获取网络服务类型。
    /// </summary>
    public abstract EServiceType ServiceType
    {
        get;
    }
    ...
    /// 获取网络地址类型。
    /// </summary>
    public EAddressFamily AddressFamily
    {
        get
        {
    ...
    public void RegisterHandler(IPacketHandler handler)
    {
        ...
        GameMain.Instance.AddListener((EventEnum)handler.Id, handler.Handle);
        m_ReceivePacketPool.Add(handler.Id);
    }
    ...
    public virtual void Connect(IPAddress ipAddress, int port, object userData)
    {
        ...
        switch (ipAddress.AddressFamily)
        {
            case System.Net.Sockets.AddressFamily.InterNetwork:
                m_AddressFamily = EAddressFamily.IPv4;
                break;

            case System.Net.Sockets.AddressFamily.InterNetworkV6:
                m_AddressFamily = EAddressFamily.IPv6;
                break;
